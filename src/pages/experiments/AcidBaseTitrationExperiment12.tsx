...
import tii from "../../assets/tii.png";
const AcidBaseTitrationExperiment12 = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-8 max-w-4xl space-y-8">
          <h1 id="Acid-Base Titration"className="text-3xl font-bold">Acid–Base Titration</h1>
...
export default AcidBaseTitrationExperiment12;
