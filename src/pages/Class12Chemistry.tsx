...
const experiments = [
  {
    ...
    description:
      "Tests for alcohols, phenols, aldehydes, ketones, and carboxylic acids.",
    slug: "functional-group-tests",
  },
  {
    id: 2,
    title: "Acid Base Titration",
    description:
      "To find the concentration of an unknown solution using a standard solution.",
        ...
        <div className="container mx-auto px-8">
          ...
          <div className="flex items-center gap-4 mb-10 animate-fade-in">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold">Chemistry Practicals</h1>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {experiments.map((exp, index) => (
              <Link
                key={exp.id}
                to={`/class-12/chemistry/${exp.slug}`}
